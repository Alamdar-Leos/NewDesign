        ...
        <div className="locations py-5">
            <div className="container py-lg-5 py-md-4 py-2">
                ...
                <div className="heading mx-auto mt-5">
                    <h4 className="title-medium heading-gold">JVC</h4>
                </div>
                ...
                <div className="heading mx-auto mt-5">
                    <h4 className="title-medium heading-gold">MEYDAN</h4>
                </div>
                <div className="row pt-md-3 pt-3">
                    <div className="col-lg-4 col-md-6 pt-md-2">
                        <Link to="/single-property">
                            <div className="box16">
                                {/* <div className="rentext-listing-category"><span>Buy</span><span>Rent</span></div> */}
                ...
                <div className="heading mx-auto mt-5">
                    <h4 className="title-medium heading-gold">WEYBRIDGE GARDENS</h4>
                </div>
                <div className="row pt-md-3 pt-3">
                    <div className="col-lg-4 col-md-6">
                        <Link to="/single-property">
                ...
                <div className="heading mx-auto mt-5">
                    <h4 className="title-medium heading-gold">HADLEY HEIGHTS</h4>
                </div>
                <div className="row pt-md-3 pt-3">
                    <div className="col-lg-4 col-md-6">
                        <Link to="/single-property">
